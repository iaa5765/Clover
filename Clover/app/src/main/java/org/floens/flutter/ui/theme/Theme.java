 ...
 */
package org.floens.flutter.ui.theme;
...
/**
 * A Theme<br>
 * Used for setting the toolbar color, and passed around {@link org.floens.flutter.chan.ChanParser} to give the spans the correct color.<br>
